   	 ...
   	 <div class="row" >
   	 	 <div class="offset-lg-1 col-lg-10 " style="min-height:500px; ">
   	 	 	<br>
   	 	 		...
   	 	 		<h3 class="text-light col-md-6">Brand List</h3>
          <br>
             ...
             <tbody>
               ...
               <tr>
                  ...
                  <td>
                    ...
                    <a class="btn btn-dark btn-hover" href="brandedit.php?brand=<?php echo $result['brandId']; ?>">Edit 

                    </a> || <a class="btn btn-dark btn-hover" href="?delbrand=<?php echo $result['brandId']; ?>">Delete</a>
