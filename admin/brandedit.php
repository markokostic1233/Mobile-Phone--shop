...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $update = $brand->updateBrand($brandName, $id);
}
   	 ...
   	 <div class="row" >
   	 	 <div class="offset-lg-1 col-lg-10 " style="min-height:500px; ">
   	 	 	<br>
   	 	 		...
   	 	 		<h3 class="text-light col-md-6">Edit Brand</h3>
          <br>
          <?php
            
        $getBr = $brand->getBrandBy($id);
        if ($getBr) {
          ...
          ?>
            ...
            <form action=" " method="post">
             ...
             <div class="form-group col-md-6">
                ...
                <input class="form-control" value="<?php echo $result['brandName']; ?>" type="text" name="brandName" placeholder="Enter brand name..">
                <br>
