   	 ...
   	 <div class="row" >
   	 	 <div class="offset-lg-1 col-lg-10 " style="min-height:500px; ">
   	 	 	<br>
   	 	 		...
   	 	 		<h3 class="text-light col-md-6">Add New Brand</h3>
          <br>
          ...
          <form action=" " method="post" name="form1" onsubmit="validation()">
            
             <div class="form-group col-md-6">
                <label class="text-light">Brand</label>
                <input class="form-control" type="text" name="brandName" id="brend" placeholder="Enter brand name.." >
                <br>
...
<script type="text/javascript">
  ...
  function validation(){
    var name = document.form1.brandName.value;
